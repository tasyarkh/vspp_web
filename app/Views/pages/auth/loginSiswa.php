               ...
               <div class="row justify-content-center">
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body">
                           <h2 class="mb-2 text-left text-primary">Login Siswa</h2>
                           <p class="text-left mb-4">Selamat Datang di V-SPP</p>
                           <?php if (session()->getFlashdata('gagal')) : ?>
                              <?= session()->getFlashdata('gagal;'); ?>
                           <?php endif; ?>
                           <form role="form" action="<?= base_url('checkSiswa'); ?>" method="POST">
                           <?= csrf_field(); ?>
                              <div class="row">
                                 <div class="col-lg-12">
                                 <div class="form-group">
                                       <label for="nisn" class="form-label">NISN</label>
                                       <input type="text" class="form-control" id="nisn" aria-describedby="nisn" name="nisn">
                                    </div>
                                 </div>
                                 <div class="col-lg-12">
                                    <div class="form-group">
                              ...
                              <div class="d-flex justify-content-left gap-3 mt-5">
                                 ...
                                 <a type="submit" class="btn btn-secondary" href="/">Petugas</a>
                              </div>
                           </form>
                        </div>
                     </div>
