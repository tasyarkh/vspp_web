     ...
     <footer class="footer">
          <div class="footer-body">
              ...
              <div class="right-panel">
                  ©<script>document.write(new Date().getFullYear())</script> V-SPP, Made with
                  <span class="">
      ...
      <div class="offcanvas-body data-scrollbar">
        <div class="row">
          <div class="col-lg-12">
            ...
            <hr class="hr-horizontal">
            <h5 class="mt-4 mb-3">Sidebar Active</h5>
            <div class="d-grid gap-3 grid-cols-2 mb-4">
              <div class="text-center">
            ...
            <hr class="hr-horizontal">
             <h5 class="mt-4 mb-3">Style Navbar</h5>
    ...
    <script>
            <?php if (session()->getFlashdata('berhasil')) { ?>
                Swal.fire({
                    ...
                    text: 'Selamat datang, <?= session('nama_user') ?>',
                    timer: 3500,
    ...
    $(document).on('click', '.bayar', function(e) {
      ...
      var spp_id = $(this).attr("data-spp_id");
...
<script>
    $(document).on('click', '.spp', function(e) {
      var id = $(this).attr("data-id");
...
<script>
    $(document).on('click', '.petugas', function(e) {
      var id = $(this).attr("data-id");
      var nama_petugas = $(this).attr("data-nama_petugas");
      ...
      $('#id_u').val(id);
      $('#nama_petugas_u').val(nama_petugas);
...
<script>
    $(document).on('click', '.st', function(e) {
      ...
      var bln_bayar = $(this).attr("data-bln_bayar");
      var th_bayar = $(this).attr("data-th_bayar");
      var spp_id = $(this).attr("data-spp_id");
      var jml_bayar = $(this).attr("data-jml_bayar");
      var ket = $(this).attr("data-ket");
      var nama_petugas = $(this).attr("data-nama_petugas");
      ...
      $('#nama_u').val(nama);
      $('#nisn_u').val(nisn);
      $('#tgl_bayar_u').val(tgl_bayar);
      $('#bln_bayar_u').val(bln_bayar);
      $('#th_bayar_u').val(th_bayar);
      $('#spp_id_u').val(spp_id);
      $('#jml_bayar_u').val(jml_bayar);
      $('#ket_u').val(ket);
      $('#nama_petugas_u').val(nama_petugas);
    }); 
    </script>
...
<script>
  <?php if (session()->getFlashdata('sppEdt')) { ?>
    ...
    Toast.fire({
      icon: 'info',
      title: 'SPP Berhasil Diubah'
    })

  <?php } ?>
</script>
<script>
  <?php if (session()->getFlashdata('tmb')) { ?>
    const Toast = Swal.mixin({
      toast: true,
      position: 'top-end',
      showConfirmButton: false,
  ...
  <?php } ?>
  <?php if (session()->getFlashdata('hps')) { ?>
    const Toast = Swal.mixin({
      toast: true,
      position: 'top-end',
      showConfirmButton: false,
