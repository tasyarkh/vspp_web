        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'dashPetugas') echo 'active'; ?>" aria-current="page" href="/dashPetugas">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'transaksiPetugas') echo 'active'; ?>" href="/transaksiPetugas" aria-current="page">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'riwayatPetugas') echo 'active'; ?>" aria-current="page" href="/riwayatPetugas">
                            <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
