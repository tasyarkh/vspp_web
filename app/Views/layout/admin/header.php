            ...
            <a href="#" class="navbar-brand">
                <div class="logo-main">
                    <div class="logo-normal">
                       <img src="../assets/images/dashboard/logo.png" style="height: 45px">
                    </div>
                    <div class="logo-mini">
                    <img src="../assets/images/dashboard/logo.png">
                    </div>
                </div>
                <h4 class="logo-title">V-SPP</h4>
            </a>
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'dashAdmin') echo 'active'; ?>" aria-current="page" href="/dashAdmin">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'spp') echo 'active'; ?>" aria-current="page" href="/spp">
                            <i class="icon">
                            ...
                            <span class="item-name">SPP</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'kelas') echo 'active'; ?>" aria-current="page" href="/kelas">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'siswaAdmin') echo 'active'; ?>" href="/siswaAdmin" aria-current="page">
                            <i class="icon">
                            <svg class="icon-20"  width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'petugasAdmin') echo 'active'; ?>" href="/petugasAdmin" aria-current="page">
                            <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'transaksiAdmin') echo 'active'; ?>" href="/transaksiAdmin" aria-current="page">
                            <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if(uri_string() == 'riwayatAdmin') echo 'active'; ?>"" aria-current="page" href="/riwayatAdmin">
                            <i class="icon">
                            <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title"><?= session('nama_petugas'); ?></h6>
                        <p class="mb-0 caption-sub-title"><?= session('level'); ?></p>
                    </div>
                  </a>  
                </li>
              </ul>
          ...
          <div class="iq-navbar-header" style="height: 215px;">
              <div class="container-fluid iq-container">
                  <div class="row">
                      <div class="col-md-12">
                          <div class="flex-wrap d-flex justify-content-between align-items-center text-secondary">
                              <div>
                                  <h3>Selamat Datang <?= session('nama_petugas'); ?></h3>
                              </div>
                          </div>
                      </div>
                  </div>
              ...
              <div class="iq-header-img">
                  <img src="../assets/images/dashboard/bg.png" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX">
              </div>
